...
export default function SchemeDetailModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-5 overflow-y-auto animate-in fade-in duration-150">
      <div className="bg-white w-full max-w-3xl rounded-2xl shadow-2xl border border-[#E5E7EB] my-auto overflow-hidden flex flex-col max-h-[90vh]">
        {/* Modal Top Header */}
        <div className="p-5 sm:p-6 bg-gradient-to-r from-[#0B3B60] to-[#07263F] text-white flex items-start justify-between gap-4 shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-xl text-white/80 hover:text-white hover:bg-white/10 transition-base cursor-pointer shrink-0"
        ...
        <div className="p-4 sm:p-5 bg-[#F7F9FB] border-t border-[#E5E7EB] flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-4 py-2.5 rounded-xl border border-[#CBD5E1] text-[#4A5568] hover:bg-white text-xs sm:text-sm font-semibold transition-base cursor-pointer"
          >
            Close
          </button>
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-[#0B3B60] hover:bg-[#07263F] text-white text-xs sm:text-sm font-bold shadow-xs transition-base flex items-center justify-center gap-2 cursor-pointer"
          >
