    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-[#E2E8F0]">
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl border border-[#E2E8F0] hover:bg-[#F8FAFC] text-xs font-semibold text-[#475569] transition-colors cursor-pointer"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-[#0B3B60] hover:bg-[#07263F] text-white font-bold text-xs sm:text-sm shadow-md transition-all cursor-pointer"
        >
